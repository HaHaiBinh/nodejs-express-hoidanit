...
import { getCartPage, getCheckoutPage, getProductPage, postAddProductToCart, postDeleteProductToCart, postHandleCartToCheckout } from 'controllers/client/product.controller'
